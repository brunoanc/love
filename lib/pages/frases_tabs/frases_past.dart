                    ...
                    pageBuilder: (context, anim1, anim2) {
                      return Theme(
                        ...
                        child: DatePickerDialog(
                          confirmText: 'OK',
                          initialDate: DateTime(2024, 2, 8), /// CHANGE to smallest of DateTime.now() and DateTime.parse(globals.frasesMap.lastKey()!)
                          firstDate:	DateTime(2024, 1, 8), /// CHANGE to DateTime(2024, 2, 8)
                          lastDate: DateTime(2025, 2, 8), /// CHANGE to smallest of DateTime.now() and DateTime.parse(globals.frasesMap.lastKey()!)
